...
##
## NOTE: this role *MUST* start with "Cloud9" for it to be permitted in a Cloud9 environment
##
ROLE_NAME=Cloud9-AwesomeAdmin

##
## NOTE: CloudFormation stacks are deleted based on their names. If you created CloudFormation
## stacks with *different* names, the `stacks` variable needs to be adjusted accordingly.
##
#stacks=(sam-app sam-app-prod sam-app-dev sam-app-pipeline aws-sam-cli-managed-prod-pipeline-resources aws-sam-cli-managed-dev-pipeline-resources)
stacks=(sam-genai-rag-prototype sam-genai-rag-prototype-prod sam-genai-rag-prototype-dev aws-sam-cli-managed-default)
